...
public class WeatherPredictionControllerTest {
  ...
  @Test
  public void weatherPredictionSuccessTest() throws Exception {
    String city = "Visnagar";
    WeatherPrediction weatherPrediction = new WeatherPrediction();
    weatherPrediction.setCode("200");
    Mockito.doReturn(weatherPrediction).when(weatherPredictionService).getWeatherPrediction(city);
    ResponseEntity<String> result = weatherPredictionController.predictWeatherForNext3Days(city);
